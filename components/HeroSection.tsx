  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center text-center text-white parallax-bg" style={{ 
      ...
      <div className="relative z-10 p-6 pt-16 md:pt-32 flex flex-col items-center max-w-4xl mx-auto">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tighter text-shadow scroll-animate fade-in delay-1">Experience</h1>
        <h2 className="text-2xl md:text-4xl font-semibold text-gray-300 tracking-wide text-shadow mt-4 scroll-animate fade-in delay-2">COSTA DEL SOL</h2>
        <p className="mt-8 text-lg md:text-xl max-w-2xl text-gray-200 leading-relaxed text-shadow scroll-animate fade-in delay-3">
          The definitive immersion in our central headquarters. Where world elite methodology meets the most exclusive Mediterranean lifestyle. Train where the professionals train.
        </p>
        <div className="mt-12 flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 scroll-animate fade-in delay-4">
